...
from ..tools.typechecking import ByteOrder
from ..tools.typechecking import Choices
from ..tools.typechecking import Formats
from ..tools.typechecking import SignalDictType
if TYPE_CHECKING:
    ...
    # Replace Data from cantools.database.diagnostics
    class Data:
        pass
try:
    import bitstruct.c
